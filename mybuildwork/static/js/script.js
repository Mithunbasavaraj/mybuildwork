...
function range_updated() {
  let range = document.document.getElementById("range");
  let max_range = document.document.getElementById("max-range");
  max_range.innerHtml = range.value;
}